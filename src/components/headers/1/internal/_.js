/**
 * @overview Modified copy of Header 1's logic for documentation.
 */

export default function() {

    // confirm usage on page
    if (document.querySelector('#docs .header-1')) {

        // store common references
        let opacity,
            platformSmall = 'small',
            platformLarge = 'large',
            compactMenuScrollTrigger = 65,
            ...
            docsPreview = document.querySelector('.preview'),
            scheduled = false;
        ...
        docsPreview.addEventListener('scroll', function() {
            ...
            if (!scheduled) {
                ...
                setTimeout(function() {
                    ...
                    if (docsPreview.scrollTop >= compactMenuScrollTrigger) {
